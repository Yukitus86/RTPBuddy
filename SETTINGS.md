...
| Zahlen in den Kacheln | `map.minimapGapNumbers` | aus | Die Trefferzahl in jede Kachel schreiben, wie auf der großen Karte. Kostet Kacheln: eine Ziffer braucht rund 13 px Kachel, damit passen sechs bis zwölf statt gut zwanzig über die Platte. Solange die Zahlen an sind, treten die Feldnummern zurück — beide wollen dieselbe Mitte; das eigene Feld steht weiter in der Beschriftung. Reicht keine Größe der Leiter für eine Ziffer, bleiben die feinen Quadrate stehen, statt dass die Ebene verschwindet |
