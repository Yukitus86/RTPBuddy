...
| Kachelfarben | `map.gapScheme` | `Ampel` | Welche vier Farben eine gezählte Kachel tragen kann. **Ampel**: grün, wo noch nie etwas gelandet ist, dann gelb, orange und rot, je häufiger — umgekehrt zur Hitzekarte gelesen, weil grün hier das Quadrat ist, das noch etwas hergibt. **Bernstein**: eine helle Farbe für die Löcher und drei leise für den Rest, wovon sich die Marker obendrauf stärker abheben. Gilt für beide Stellen mit gezählten Kacheln — die große Karte ab 2k Maßstab und die Minikarte; die Schattierung unter 2k bleibt unberührt. Die Zahl in der Kachel nimmt ihre Farbe aus dem Band unter ihr, damit sie auf allen vier lesbar bleibt |
| Beim Teleport offen halten | `map.reopenAfterTeleport` | an | Ein Teleport über Welten hinweg blendet den Ladebildschirm des Spiels ein und schließt dabei alles Offene. Mit diesem Schalter wird dieser eine Wechsel abgelehnt: es ist dieselbe Karte, die stehen bleibt — kein Blinken, kein Neuaufbau, Filter, Zoom, Scrollstand und Auswahl unverändert. Nur die Ladebildschirme des Spiels werden abgelehnt; alles, was du oder der Server absichtlich öffnet (Trennungsmeldung voran), kommt durch. Escape schließt weiterhin endgültig |
...
| Gezählte Kacheln | `map.minimapShowGapTiles` | an | Die gezählten Kacheln der großen Karte auf der Platte, in denselben Farben und auf demselben Gitter: feste Weltquadrate, von der Ecke der Weltgrenze aus gezählt. Die Größe wählt die Platte selbst — rund 22 Kacheln über den eingerahmten Boden, gerundet auf eine Größe, die eine Serverregion glatt teilt, und mindestens 3 px breit. Die Kachel hängt damit am Boden und nicht an der Plattengröße: eine kleinere Minikarte zeigt dieselbe Karte kleiner statt eine gröbere. Gezählt wird, was die Platte einrahmt — also das, was **Datensatz** sagt |
| Zahlen in den Kacheln | `map.minimapGapNumbers` | aus | Die Trefferzahl in jede Kachel schreiben, wie auf der großen Karte. Kostet Kacheln: eine zweistellige Zahl braucht rund 11 px Kachel, damit passen sechs bis zwölf statt gut zwanzig über die Platte. Die Ziffern werden auf drei Viertel verkleinert und alle gleich groß gezeichnet, nach der breitesten Zahl im Bild — Kachel für Kachel bemessen fehlten sonst ausgerechnet die zweistelligen. Solange die Zahlen an sind, treten die Feldnummern zurück — beide wollen dieselbe Mitte; das eigene Feld steht weiter in der Beschriftung. Reicht keine Größe der Leiter für eine Ziffer, bleiben die feinen Quadrate stehen, statt dass die Ebene verschwindet |
