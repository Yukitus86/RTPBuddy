...
| Kachelgröße | `map.gapRasterTile` | 8.000 Blöcke | Boden, für den eine gezählte Kachel steht: 2.000 · 4.000 · 8.000 · 16.000 · 32.000. Früher wuchs die Kachel beim Herauszoomen mit: gleiche Größe auf dem Schirm, immer mehr Welt dahinter, zuletzt 64 000 Blöcke Kantenlänge. Jetzt gehalten, bis der Maßstab 100k überschreitet |
...
| `map.gapRasterTile` | 8.000 | Boden, für den eine gezählte Kachel im Lücken-Modus steht, in Blöcken. Umschaltbar unter **Karte → Kachelgröße**. Ab 100k Maßstab greift wieder die alte, mit dem Zoom mitwachsende Kachel, weil die gehaltene dort unter drei Pixel fällt |
